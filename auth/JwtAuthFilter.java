...
/**
 * Auth filter used for authentication and authorization with @RolesAllowed annotation.
 * @param <P> principal user object.
 */
...
public class JwtAuthFilter<P extends Principal> extends AuthFilter<JwtContext, P> {
    ...
    public static class Builder<P extends Principal>
            extends AuthFilterBuilder<JwtContext, P, JwtAuthFilter<P>> {
